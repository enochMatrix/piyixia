/*
Component includes the comment bar
...
class CommentForChallenge extends Component {
                ...
                <View>
                    <View style={[styles.inputBoxContainer, { bottom: this.state.keyboardHeight }]}>
                        ...
                        <View style={{ alignItems: 'flex-end', justifyContent: 'flex-end' }}>
                            <Button title='发送' color='green' onPress={this.commentSubmitHandler}/>
                        </View>
                    </View>
                </View>
            );
    ...
    render() {
        console.log('renderCommentforChallenge', this.state.commentInput);
        return (
            <View style={{ flex: 1 }}>
                {/*USER COMMENT AREA*/}
                <TouchableOpacity
                ...
                >
                    <Pen color='black' />
                    <Text style={{ color: 'black', paddingLeft: '1%', fontWeight: '800' }}>
...
export default CommentForChallenge;
